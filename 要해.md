...
* Demographics?
    * Variables
        * [x] Population
        * [ ] Wealth of the city
            * I.E. Low-magic, Medium-magic, or High-magic world
        * [ ] Magicness of the world
            * Can use the 5e lifestyle labels:
...
* Magic Shop Generator
    * Variables
        * User Inputs
            * [x] Population
                * Larger cities get a multiplier to their 'stock die' rolls
                * The more common an item's rarity, the larger the 'stock die'
            * [ ] Magicness of the world
                * I.E. Low-magic, Medium-magic, or High-magic world
            * [ ] Wealth of the city
                * Can use the 5e lifestyle labels:
        ...
        * Pulled from Database
            * [ ] Price Modifier based on population
                * [ ] Buying
                * [ ] Selling
            * [x] 'Stock Die'
            * [x] Multiplier
